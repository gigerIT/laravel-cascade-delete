...
[![Latest Version on Packagist](https://img.shields.io/packagist/v/gigerit/laravel-cascade-delete.svg?style=for-the-badge)](https://packagist.org/packages/gigerit/laravel-cascade-delete)
[![GitHub Tests Action Status](https://img.shields.io/github/actions/workflow/status/gigerit/laravel-cascade-delete/CI.yml?branch=main&label=tests&style=for-the-badge)](https://github.com/gigerit/laravel-cascade-delete/actions?query=workflow%3ACI+branch%3Amain)
[![Total Downloads](https://img.shields.io/packagist/dt/gigerit/laravel-cascade-delete.svg?style=for-the-badge)](https://packagist.org/packages/gigerit/laravel-cascade-delete)
